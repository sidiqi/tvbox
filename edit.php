...
$result = mysqli_query($link, $query); 
	...
	if(isset($_POST['save']) && ($_POST['status'])){	

		$status = '<font color="green">Работает</font>';

		$success_eddit = $mysqli->query ("UPDATE `console` SET name='$name', model='$model', placement='$placement', status='$status', video='$video_link' WHERE ConsoleID = '$id'");
	...
	$success_eddit2 = $mysqli->query ("UPDATE `console` SET name='$name', model='$model', placement='$placement', status='$status2', video='$video_link' WHERE ConsoleID = '$id'");
...
<div class="container">
	...
	<div class="col-md-3"></div>
		...
		<div class="col-md-6" style="padding-top: 5%">
				<h2>Редактировать приставку</h2><hr>
		...
		<form method="POST" action="edit.php?id=<?php echo $id; ?>">
			...
			<div class="input-group mb-3">
			  ...
			  <select required name="placement" class="custom-select" id="inputGroupSelect01">
				<option selected value="<?php echo $key['placement']; ?>"><?php echo $key['placement_name']; ?></option>
			...
			<div class="container row"> 
				<div class="col-md-9" style="padding-top: 5px!important">
				...
				<div class="col-md-3">
					<input value="Сохранить" type="submit" id="edit" name="save" type="button" class="btn btn-primary text-right"/>
				</div>
			</div>
